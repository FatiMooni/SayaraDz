...
class AjouterAnnonceActivity : AppCompatActivity(),SharedPreferenceInterface {
     ...
     */
    private fun createViheculeService() : ViheculeService {
        return ServiceBuilder.buildService(ViheculeService::class.java)
    }
    ...
    private fun recupererMarque(){
        val requestCall = this.vService.getMarques()
        ...
        requestCall.enqueue(object : Callback<List<Marque>> {
            ...
            override fun onResponse(call: Call<List<Marque>>, response: Response<List<Marque>>) =
                if(response.isSuccessful){
                    ...
                    Toast.makeText(this@AjouterAnnonceActivity, "there is a problem in our server",
    ...
    fun chipsOption(id: Int?) {
        val vService = createViheculeService()
        val requestCall = vService.getOptions(id!!)
        ...
        requestCall.enqueue(object : Callback<List<Option>> {
            override fun onResponse(call: Call<List<Option>>, response: Response<List<Option>>) =
                if (response.isSuccessful) {
                    ...
                    chip.chipText = "Add"
                    chip.chipBackgroundColor = ContextCompat.getColorStateList(this@AjouterAnnonceActivity,R.color.colorAccent)
            ...
            override fun onFailure(call: Call<List<Option>>
                                   , t: Throwable) {
