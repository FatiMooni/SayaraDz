...
import com.example.sayaradzmb.*
import com.example.sayaradzmb.R
import com.example.sayaradzmb.Repository.controller.AauthentifiactionController
import com.example.sayaradzmb.helper.SharedPreferenceInterface
import com.example.sayaradzmb.model.Automobiliste
import com.example.sayaradzmb.ui.activities.AcuilleActivity
import com.facebook.*
...
class LoginActivity : AppCompatActivity(), SharedPreferenceInterface {
    ...
    fun connxionSuccefulGoogle(account : GoogleSignInAccount){
         ...
         */
        if(AauthentifiactionController.googleConnexion(token,automobiliste,this@LoginActivity)){
            dejaConnecte()
        }
    ...
    fun connexionSuccessFace(loginResult : LoginResult){
         ...
         *
         */
        if(AauthentifiactionController.facebookConnexion(token,automobiliste,this@LoginActivity)){
            dejaConnecte()
        }
    }
